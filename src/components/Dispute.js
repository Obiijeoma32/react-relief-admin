  ...
  return (
    <>
      ...
      <div className="main-transaction-table">
        <h2 className="main-transaction-header">{/* <!-- Tools  --> */}</h2>
        <br />

        <div className="dispute-table-options">
          <div className="transaction-table-input">
            ...
            <input className="search-transaction" style={{ border: "none", marginRight: "-26rem", marginbottom: "15px", outline: "none", width: "600px" }} type="text" placeholder="Search  for  dispute" />
          </div>

          <div style={{ paddingTop: "6px", marginLeft: "30px" }} className="transaction-table-filter1">
          ...
          <div style={{ marginRight: "20px", paddingTop: "6px" }} className="transaction-table-filter1">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <table onClick={() => setModal(true)} className="transaction-table-output">
          <thead>
            <tr>
              <th>
      ...
      {modal && <DisputeModal closeModal={setModal} />}
    </>
  );
}
