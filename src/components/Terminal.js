    ...
    <>
      ...
      <div className="main-transaction-table">
        <div className="user-header-transaction">
          <h2 className="main-transaction-header">Terminal</h2>
          <button onClick={() => setForm(true)} className="terminal-page-button" type="submit">
            Add Terminal
          </button>
        </div>

        <div className="terminal-table-options">
          <div className="terminal-table-input">
            <svg style={{ color: "#4d708d" }} className="search-transaction" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
            </svg>
            <input className="search-transaction" style={{ border: "none", marginRight: "-26rem", marginBottom: "15px", outline: "none", width: "550px" }} type="text" placeholder="Search  for  terminal" />
          </div>

          <div style={{ paddingTop: "6px", marginLeft: "28px" }} className="transaction-table-filter">
          ...
          <div style={{ marginRight: "20px", paddingTop: "6px" }} className="transaction-table-filter">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <table className="user1-table-output" onClick={() => setModal(true)}>
          <thead>
            <tr>
              <th>
      ...
      {form && <TerminalForm closeForm={setForm} />}
      {modal && <TerminalModal closeModal={setModal} />}
    </>
  );
}
