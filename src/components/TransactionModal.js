        ...
        <div className="transaction-modal-content">
          <div className="transaction-modal-card">
            <div className="transaction-box-listing">
              <h3 className="list-header">Transaction Details</h3>
              <div className="transaction-listing-details">
                <div className="transaction-list-box1">
                  <h4>
                ...
                <div className="transaction-list-box2">
                  <h4>
            ...
            <button className="transaction-close-button" type="button" onClick={() => closeModal(false)}>
              Close
            </button>
          </div>
        </div>
