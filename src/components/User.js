...
function User() {
  ...
  const [userForm2, setUserForm2] = useState(false);
  const [userForm3, setUserForm3] = useState(false);
  ...
  return (
    <>
      ...
      <div className="main-transaction-table">
        <div className="user-header-transaction">
          <h2 className="main-transaction-header">Users</h2>
          <button onClick={() => setUserForm(true)} className="user-page-button" type="button">
            Add User
          </button>
        </div>
        ...
        <div className="user-table-options">
          <div className="transaction-table-input">
            ...
            <input className="search-transaction" style={{ border: "none", marginRight: "-26rem", marginBottom: "15px", outline: "none", width: "600px" }} type="text" placeholder="Search for user" />
          </div>

          <div style={{ marginLeft: "28px" }} className="transaction-table-filter">
          ...
          <div style={{ marginRight: "12px" }} className="transaction-table-filter">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="user-export-button">Export</span>
          </div>
        </div>
        <table onClick={() => setModal(true)} className="user1-table-output table-content">
          <thead>
            <tr>
              <th>
          ...
          <tbody>
            <tr>
              ...
              <td>220626160803</td>
              <td>Admin@nubeero.com</td>
              <td>Superadmin</td>
              <td>
                <h4 className="enabled">Enabled</h4>
              </td>
              <td>
      ...
      {modal && <UserModal closeModal={setModal} />}
      {userForm && <UserForm handleNextButton={handleNextButton} closeForm={closeForm} />}
      {userForm2 && <UserForm2 closeForm={closeForm} handleNextFormbutton={handleNextFormbutton} />}
      {userForm3 && <UserForm3 closeForm={closeForm} />}
    </>
  );
}
