...
function NextDispute({ closeNext }) {
  return (
    <>
      <div className="alltransactionmodal-container" onClick={closeNext}>
        <div className="alltransaction-content">
          <div className="alltransaction-details">
            <div className="transactiondispute-box">
              ...
              <div onClick={closeNext}>Continue</div>
            </div>
          </div>
        </div>
      </div>
